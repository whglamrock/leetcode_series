...
# 3) You don't need to scan all the way to i == len(nums) - 1 (because if you already stand at the last position you
# don't need to further increment the number of jumps). It's also guaranteed from the problem description you can
# reach the end.
class Solution:
